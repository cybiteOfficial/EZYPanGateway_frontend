...
export interface TabPaymentDetailITRSliceStateType {
...
const initialState: TabPaymentDetailITRSliceStateType = {
  items: [],
  totalItems: 0,
...
const TabPaymentDetailITRSliceApplicationSlice: Slice<TabPaymentDetailITRSliceStateType> =
  createSlice({
    name: "TabPaymentDetailITRSliceApplication",
    initialState,
    reducers: {
      resetState: (state) => {
        return initialState;
...
export const {
  ...
  setDateFilter,
  resetState,
} = TabPaymentDetailITRSliceApplicationSlice.actions;
export default TabPaymentDetailITRSliceApplicationSlice.reducer;
