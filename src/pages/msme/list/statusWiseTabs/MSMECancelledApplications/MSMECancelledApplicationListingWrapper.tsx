...
import MSMECancelledApplicationListing from "./MSMECancelledApplicationListing";
import { useGetMSMECancelledApplicationsQuery } from "src/services/MSMEService";
...
import {
  ...
  setItems,
  setTotalItems,
} from "src/redux/slices/MSMEApplication/MSMECancelledApplicationSlice";
...
const MSMECancelledApplicationListingWrapper = () => {
  const dispatch = useDispatch<AppDispatch>();
  // Slice
  const MSMECancelledApplicationState: any = useSelector(
    (state: RootState) => state.MSMECancelledApplication
  );
  const { page, rowsPerPage, items, searchValue, filterBy } =
    MSMECancelledApplicationState;
  // Get Data Query
  const { data, isFetching, isLoading } = useGetMSMECancelledApplicationsQuery({
    limit: rowsPerPage,
  ...
  return (
    <>
      <MSMECancelledApplicationListing
...
export default MSMECancelledApplicationListingWrapper;
