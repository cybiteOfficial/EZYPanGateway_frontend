...
const PANListing = ({ statusWiseCount, isCountLoading = false }: Props) => {
          ...
          return (
            ...
            >
              ...
              {isCountLoading ? (
                ...
                <div
                  className={twMerge(
                    `  text-[12px] flex justify-center items-center rounded-full font-medium ${status?.label ==='DONE' ? 'w-14 h-6' : ' w-6 h-5'  } ${
                      pathname.split("/")[2] === status.path
