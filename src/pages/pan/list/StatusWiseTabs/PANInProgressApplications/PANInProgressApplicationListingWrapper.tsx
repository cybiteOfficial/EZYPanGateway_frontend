...
import { useGetPanInProgressApplicationsQuery } from "src/services/PANService";
import { formatDateAndTime } from "src/utils/dateAndTime";
import PANInProgressApplicationListing from "./PANInProgressApplicationListing";
...
const PANInProgressApplicationListingWrapper = () => {
  // Dispatch Hook
  ...
  // Get Data Query
  const { data, isFetching, isLoading } = useGetPanInProgressApplicationsQuery({
    limit: rowsPerPage,
  ...
  return (
    <>
      <PANInProgressApplicationListing
...
export default PANInProgressApplicationListingWrapper;
