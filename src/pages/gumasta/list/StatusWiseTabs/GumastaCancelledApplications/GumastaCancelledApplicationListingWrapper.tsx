...
import GumastaCancelledApplicationListing from "./GumastaCancelledApplicationListing";
import { useDispatch, useSelector } from "react-redux";
import { AppDispatch, RootState } from "src/redux/store";
import { useGetGumastaCancelledApplicationsQuery } from "src/services/GumastaService";
import {
  setIsTableLoading,
  setItems,
  setTotalItems,
} from "src/redux/slices/GumastaApplication/GumastaCancelledApplicationSlice";
...
const GumastaCancelledApplicationListingWrapper = () => {
  const dispatch = useDispatch<AppDispatch>();
  // Slice
  const GumastaCancelledApplicationState: any = useSelector(
    (state: RootState) => state.GumastaCancelledApplication
  );
  const { page, rowsPerPage, items, searchValue, filterBy } =
    GumastaCancelledApplicationState;
  ...
  return (
    <>
      <GumastaCancelledApplicationListing
...
export default GumastaCancelledApplicationListingWrapper;
