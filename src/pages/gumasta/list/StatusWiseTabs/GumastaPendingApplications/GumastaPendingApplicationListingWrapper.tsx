...
import GumastaPendingApplicationListing from "./GumastaPendingApplicationListing";
...
import {
  ...
  setItems,
  setTotalItems,
} from "src/redux/slices/GumastaApplication/GumastaPendingApplicationSlice";
...
const GumastaPendingApplicationListingWrapper = () => {
  const navigate = useNavigate();
  const dispatch = useDispatch<AppDispatch>();
  // Slice
  const GumastaPendingApplicationState: any = useSelector(
    (state: RootState) => state.GumastaPendingApplication
  );
  const { page, rowsPerPage, items, searchValue, filterBy } =
    GumastaPendingApplicationState;
  const [changeStatus] = useChangeGumastaStatusMutation();

  // Get Data Query
  const { data, isFetching, isLoading } = useGetGumastaPendingApplicationsQuery(
    {
      limit: rowsPerPage,
  ...
  return (
    <>
      <GumastaPendingApplicationListing
...
export default GumastaPendingApplicationListingWrapper;
