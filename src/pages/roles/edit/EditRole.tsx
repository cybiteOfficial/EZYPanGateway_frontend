...
import { EditRoleInitialValues } from "./EditRoleWrapper";
import { IoImageOutline, IoPerson } from "react-icons/io5";
import { BiCheck, BiSearch, BiChevronUp } from "react-icons/bi";

type Props = {
  formikProps: FormikProps<EditRoleInitialValues>;
  modulesOptions: {
    moduleGroup: string;
    actions: string[];
    fields: {
...
const EditRole = ({ formikProps, modulesOptions, isLoading }: Props) => {
