...
import TabDistributorApplicationPANList from "./TabDistributorApplicationPANList";
...
const TabDistributorApplicationPANListWrapper = () => {
  ...
  return (
    <>
      <TabDistributorApplicationPANList
...
export default TabDistributorApplicationPANListWrapper;
