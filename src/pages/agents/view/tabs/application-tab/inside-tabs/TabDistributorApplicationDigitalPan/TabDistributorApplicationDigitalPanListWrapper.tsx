...
import TabDistributorApplicationDigitalPanList from "./TabDistributorApplicationDigitalPanList";
...
const TabDistributorApplicationDigitalPanListWrapper = () => {
    ...
    dispatch(
      setFilterBy(
        filterBy.map((filter: any) => {
          if (filter.fieldName === "distributorCode") {
            return {
              ...filter,
  ...
  return (
    <>
      <TabDistributorApplicationDigitalPanList
...
export default TabDistributorApplicationDigitalPanListWrapper;
