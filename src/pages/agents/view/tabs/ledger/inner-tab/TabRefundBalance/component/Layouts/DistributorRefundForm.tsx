...
import { DistributorRefundFormValues } from "../Add/AddDistributorRefundBalanceWrapper";
import { handleValidNumber } from "src/utils/regularExpression";
import ATMSelect from "src/components/UI/atoms/formFields/ATMSelect/ATMSelect";
import { IoClose } from "react-icons/io5";

type Props = {
  formikProps: FormikProps<DistributorRefundFormValues>;
  onClose: () => void;
  formType: "Add" | "Edit";
};
...
const DistributorRefundForm = ({ formikProps, onClose, formType }: Props) => {
...
export default DistributorRefundForm;
