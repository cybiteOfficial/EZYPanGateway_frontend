...
import { useGetRewardEntryInLedgerQuery, useUpdateRewardEntryInLedgerMutation } from "src/services/RewardService";
...
const EditDistributorRewardWrapper = ({ onClose, RewardId }: Props) => {
...
export default EditDistributorRewardWrapper;
