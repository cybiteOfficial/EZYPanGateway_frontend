...
import { DistributorRewadFormValues } from "../Add/AddDistributorRewardWrapper";
import { handleValidNumber } from "src/utils/regularExpression";
import ATMSelect from "src/components/UI/atoms/formFields/ATMSelect/ATMSelect";
import { IoClose } from "react-icons/io5";

type Props = {
  formikProps: FormikProps<DistributorRewadFormValues>;
  onClose: () => void;
  formType: "Add" | "Edit";
};
...
const DistributorRewardForm = ({ formikProps, onClose, formType }: Props) => {
    ...
    <div className="flex p-4 flex-col gap-6 relative">
      <div className="flex justify-between items-center">
        <div className="text-xl font-medium">
          {formType === "Add" ? "Add Reward" : "Update Reward"}
        </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div>
          <ATMTextField
            ...
            onChange={(e) =>
              handleValidNumber(e) &&
              setFieldValue("rewardPoints", e.target.value)
            }
            label="Points"
...
export default DistributorRewardForm;
