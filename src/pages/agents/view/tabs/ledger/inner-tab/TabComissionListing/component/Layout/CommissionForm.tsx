...
import { CommissionFormValues } from "../Add/AddCommissionWrapper";
import { handleValidNumber } from "src/utils/regularExpression";
import ATMSelect from "src/components/UI/atoms/formFields/ATMSelect/ATMSelect";
import { IoClose } from "react-icons/io5";

type Props = {
  formikProps: FormikProps<CommissionFormValues>;
  onClose: () => void;
  formType: "Add" | "Edit";
};
...
const CommissionForm = ({ formikProps, onClose, formType }: Props) => {
