...
import TabGuestApplicationPANListing from "./TabGuestApplicationPANListing";
import {
  setFilterBy,
  setIsTableLoading,
  setItems,
...
const TabGuestApplicationPANListingWrapper = () => {
...
export default TabGuestApplicationPANListingWrapper;
