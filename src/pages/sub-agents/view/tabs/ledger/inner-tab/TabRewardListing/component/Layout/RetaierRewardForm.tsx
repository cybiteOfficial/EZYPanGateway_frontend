...
import { RetaierRewardFormValues } from "../Add/AddRetailerRewardWrapper";

type Props = {
  formikProps: FormikProps<RetaierRewardFormValues>;
  onClose: () => void;
  formType: "Add" | "Edit";
};
...
const RetaierRewardForm = ({ formikProps, onClose, formType }: Props) => {
...
export default RetaierRewardForm;
