...
import TabRetailerApplicationPANListing from "./TabRetailerApplicationPANListing";
...
const TabRetailerApplicationPANListingWrapper = () => {
  ...
  return (
    <>
      <TabRetailerApplicationPANListing
...
export default TabRetailerApplicationPANListingWrapper;
