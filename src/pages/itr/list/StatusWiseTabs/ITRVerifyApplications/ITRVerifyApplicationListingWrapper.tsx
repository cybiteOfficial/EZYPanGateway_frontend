...
import ITRVerifyApplicationListing from "./ITRVerifyApplicationListing";
...
const ITRVerifyApplicationListingWrapper = () => {
  ...
  // Get Data Query
  const { data, isFetching, isLoading } = useGetItrVerifiedApplicationsQuery({
    limit: rowsPerPage,
...
export default ITRVerifyApplicationListingWrapper;
