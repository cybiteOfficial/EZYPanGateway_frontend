...
import {
  ...
  setItems,
  setTotalItems,
} from "src/redux/slices/ITRApplication/ITRCancelledApplicationSlice";
import { AppDispatch, RootState } from "src/redux/store";
import { useGetItrCancelledApplicationsQuery } from "src/services/ITRApplicationServices";
import { formatDateAndTime } from "src/utils/dateAndTime";
import ITRCancelledApplicationListing from "./ITRCancelledApplicationListing";
...
const ITRCancelledApplicationListingWrapper = () => {
  const dispatch = useDispatch<AppDispatch>();
  // Slice
  const ITRCancelledApplicationState: any = useSelector(
    (state: RootState) => state.ITRCancelledApplication
  );
  const { items, searchValue, rowsPerPage, page, filterBy, dateFilter } =
    ITRCancelledApplicationState;
  ...
  // Get Data Query
  const { data, isFetching, isLoading } = useGetItrCancelledApplicationsQuery({
    limit: rowsPerPage,
  ...
  return (
    <>
      <ITRCancelledApplicationListing
...
export default ITRCancelledApplicationListingWrapper;
